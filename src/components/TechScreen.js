...
state = {
  ...
  featchnews = () => {
    fetch('https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=5359df3deeca4fda93007ce1f9b4cc5a')
    .then((res) => res.json())
    .then((response) => {
      this.setState({
      ...
      return (
        <View style={styles.container}>
          <View style={styles.header}>
            <Text style={{fontSize:30, color: '#fff', marginTop: 15, marginBottom: 5, textAlign: "center", fontFamily: 'medium'}}>Top Tech News</Text>
          </View>
